...
import EmptyCart from '../components/assets/emptycart.jpg';
    ...
    exit={{opacity : 0, x : 200}}
     className='fixed top-0 right-0 w-full md:w-375 h-screen bg-white drop-shadow-md flex flex-col z-[101]'>
        ...
        <div className='w-full flex items-center justify-between'>
            ...
            <div className='w-full flex items-center justify-between'>
                <p className='text-gray-200 tezt-xl font-semibold'>Total</p>
                <p className='text-gray-200 tezt-xl font-semibold'>₱ {tot + 0}</p>
            </div>
            {user ? (
            <motion.button 
            whileTap={{ scale : 0.8 }} 
