...
import Delivery from '../components/assets/driver delivery.jpg';
import Highlight from '../components/assets/light orange background.jpg';
          ...
          <div className='py-2 flex-1 flex flex-col items-start justify-center gap-6'>
            <div className='flex items-center gap-2 justify-center bg-orange-100 px-4 py-1 rounded-full'>
              ...
              <div className='w-8 h-8 bg-white rounded-full overflow-hidden drop-shadow-xl'>
                <img src={Delivery} className='w-full h-full object-contain' alt='driver delivery'/>
              </div>
            </div>
            ...
            <p className='text-base text-textColor text-center md:text-left md:w-[80%] '> Alberto's Pizza proudly started as a small-time pizza store in Cebu City near the Vicente Sotto Memorial Medical Center.
            ...
            <div className='py-2 flex-1 flex items-center relative'>
              <img src={Highlight} className='ml-auto h-420 w-full lg:w-auto lg:h-650 rounded-3xl' alt='highlight' />
              ...
              {heroData && heroData.map(n => (
                <div key={n.id} className='lg:w-190 p-4 bg-cardOverlay backdrop-blur-md rounded-3xl flex flex-col items-center justify-center drop-shadow-lg'>
                  <img src={n.assetsSrc} className='w-20 lg:w-40 -mt-10 lg:-mt-20' alt='margarita' />
